...
import static net.wirelabs.etrex.uploader.common.Constants.STRAVA_AUTHORIZATION_URL;
import static net.wirelabs.etrex.uploader.common.Constants.STRAVA_DEFAULT_APP_ACCESS_SCOPE;
...
public class StravaAuthorizer extends StravaApiCaller {
    ...
    private String buildAuthorizationUrl(String redirectUri) {
        ...
        HttpUrl url = HttpUrl.parse(STRAVA_AUTHORIZATION_URL);
        ...
        return url.newBuilder()
                ...
                .addQueryParameter("scope", STRAVA_DEFAULT_APP_ACCESS_SCOPE)
                .build().toString();

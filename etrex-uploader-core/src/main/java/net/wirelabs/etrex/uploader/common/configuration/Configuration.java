...
import static net.wirelabs.etrex.uploader.common.Constants.DEFAULT_LOCAL_STORE;
import static net.wirelabs.etrex.uploader.common.Constants.EMPTY_STRING;
...
public class Configuration extends PropertiesBasedConfiguration {
    ...
    public Configuration(String configFile) {
        super(configFile);
        storageRoot = properties.getProperty(STORAGE_ROOT, System.getProperty("user.home") + File.separator + DEFAULT_LOCAL_STORE);
        userStorageRoots = properties.getProperty(USER_STORAGE_ROOTS, EMPTY_STRING);
        ...
        stravaAppId = properties.getProperty(STRAVA_APP_ID, EMPTY_STRING);
        stravaClientSecret = properties.getProperty(STRAVA_CLIENT_SECRET, EMPTY_STRING);
        stravaAccessToken = properties.getProperty(STRAVA_ACCESS_TOKEN, EMPTY_STRING);
        stravaRefreshToken = properties.getProperty(STRAVA_REFRESH_TOKEN, EMPTY_STRING);

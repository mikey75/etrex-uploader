...
public class Constants {
    ...
    public static final String APPLICATION_IDENTIFICATION = String.format("Etrex Uploader ver: %s (%s) 2022 Michał Szwaczko, WireLabs Technologies", EtrexUploaderRunner.getAppVersion(), COPYRIGHT_SIGN);

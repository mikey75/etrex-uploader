...
public class Constants {
    ...
    public static final String APPLICATION_IDENTIFICATION = String.format("Etrex Uploader ver: %s (Jmaps ver: %s) © 2022 Michał Szwaczko, WireLabs Technologies" , SystemUtils.getAppVersion(),  SystemUtils.getJmapsVersion());
